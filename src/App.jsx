...
function App(){
  ...
  if(!data?.hasOwnProperty('main')){
    return (
      <section className='overflow-hidden bg-[url("./src/assets/images/soleado.jpg")] bg-cover bg-top bg-no-repeat w-sreen h-screen flex items-center justify-center flex-col gap-3 relative'>
